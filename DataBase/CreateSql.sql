...
ALTER TABLE [dbo].[SysUserConfig]  WITH CHECK ADD  CONSTRAINT [FK_SysUserConfig_SysUser] FOREIGN KEY([UserId])
REFERENCES [dbo].[SysUser] ([Id])
GO

ALTER TABLE [dbo].[SysUserConfig] CHECK CONSTRAINT [FK_SysUserConfig_SysUser]
GO
